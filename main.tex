...
\makeatletter
\renewcommand\@bibitem[1]{\item\if@filesw \immediate\write\@refout
...
\ip{ref/RazvanMarinescu_CV.pdf}
  
\ex{2}{Google Scholar Profile of Dr. Razvan Marinescu}
\ip{ref/google_scholar.pdf}
...
\end{itemize}
 ...
 \ip{ref/tadpole_press.pdf}
 \ip{ref/alzforum_wiki.pdf}
...
\ip{ref/adevarul_translation.pdf}
\ip{ref/adevarul_wiki.pdf}
...
\ex{20}{Evidence towards Dr. Marinescu’s leadership role in the organization of TADPOLE Challenge}
  ...
  \begin{enumerate}
   ...
   \item First pages of three articles authored by \dr on the TADPOLE Challenge, confirming his leadership role through first-authorship.
  \end{enumerate}
%\ip{ref/tadpole_raz_results.pdf}
%\ip{ref/tadpole_raz_email.pdf}
%\ip{ref/tadpole_raz_frs.pdf}
%\ip{ref/tadpole_raz_video.png}
%\ip{articles/tadpole2018.pdf}
%\ip{articles/tadpole2020.pdf}
%\ip{articles/tadpole2019miccai.pdf}
 ...
 \ip{ref/gscholar_discipline.pdf}
...
%\ip{ref/phd_diploma.jpg}
%\ip{ref/phd_confirmation_award.pdf}
%\ip{ref/phd_confirmation_award2.pdf}
%\ip{ref/imperial_proof_enrolment.pdf}
%\ip{ref/imperial_confirmation_student_status.pdf}
%\ip{ref/transcript_imperial.pdf}
